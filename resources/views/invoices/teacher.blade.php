...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; padding: 2px 6px; background: #eef2ff; color: #3730a3; border-radius: 999px; font-size: 10px; }
    </style>
    </head>
<body>
    <div class="header" style="justify-content: center;">
        <div class="brand" style="flex-direction: column; align-items: center; text-align: center;">
            ...
            <div class="muted">Teacher Invoice • {{ $month }}</div>
        </div>
    </div>
        ...
        <tbody>
            @foreach($entries as $e)
                <tr>
                    ...
                    <td>{{ $e['student'] }}</td>
                    <td>{{ $e['date'] }}</td>
                    <td class="right">{{ number_format($e['teacher_percent'] ?? 0, 2) }}%</td>
