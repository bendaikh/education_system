...
<template>
  <AdminLayout title="Educational Support Reports">
    <Head title="Educational Support Reports" />
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <h1 class="text-xl font-semibold text-gray-900 mb-2">Educational Support Reports</h1>
      ...
      <div class="overflow-x-auto mb-6">
        <table class="min-w-full">
          ...
          <tbody class="divide-y">
            <tr v-for="p in props.payments" :key="p.id">
