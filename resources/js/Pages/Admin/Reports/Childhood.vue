...
<template>
  <AdminLayout title="Childhood Education Reports">
    <Head title="Childhood Education Reports" />
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <h1 class="text-xl font-semibold text-gray-900 mb-2">Childhood Education Reports</h1>
