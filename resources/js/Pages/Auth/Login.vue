    ...
    <div class="flex flex-1 justify-center items-center px-6 py-20">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-400">Sign in to access your EduConnect dashboard</p>
        </div>
        ...
        <div class="bg-gray-800 rounded-xl p-8 shadow-2xl border border-gray-700">
          ...
          <div class="mt-8 p-4 bg-gray-700 rounded-lg border border-gray-600">
            ...
            <div class="text-xs text-gray-400 space-y-1">
              <p><strong>SuperAdmin:</strong> admin@academy.com / password123</p>
            </div>
          </div>
        </div>
